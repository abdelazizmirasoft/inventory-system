                    ...
                    <div class="tabbable">
                      ...
                      <div class="tab-content no-border padding-24">
                            ...
                            <div class="col-xs-12 col-sm-9">
                              <h4 class="blue">
                                ...
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                      <span><b><?php echo $facture->nom_client; ?></b></span>
                                    </div>
                                </div>
                                <div class="profile-info-row">
                       ...
                       <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                      <?php $items= ItemFacture::find_by_sql("SELECT * FROM itemFacture WHERE id_facture=".$database->escape_value($facture->id)); ?>  
                      <?php foreach($items as $item): ?>
                        <tr>
                        <?php $product = Product::find_by_id($item->id_product);?>
                          <td><?php echo $product->PART_NUMBER; ?></td>
                          <td><?php echo $product->DESCRIPTION; ?></td>
                          <td><?php echo number_format($item->PU_VENTE); ?></td>
                      ...
                      <h2>Historique des versements:</h2>
                       <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                      <?php $items= VersementVente::find_by_facture($facture->id); 
                      //print_r($items); ?>  
                      <?php foreach($items as $item): ?>
                        <tr>                        
...
<div class="row">
  <div class="col-md-7">
    <a href="facturation/print_facture.php?id=<?php echo $facture->id;?>" target="_blank" ><input class="btn btn-primary pull-right" value="Imprimer Facture" /></a>
  </div>
</div>
