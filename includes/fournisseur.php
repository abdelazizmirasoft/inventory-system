...
class Fournisseur extends DatabaseObject {
	...
	protected static $db_fields=array('id', 'nom', 'adresse_four', 'tel', 'libele_for', 'RaisonSociale', 'Ville', 'Adresse_Courriel', 'dette');
	public $id;
	public $nom;
	public $tel;
	public $libele_for;
  ...
  public function attach_file($file) {
  	...
  	public function history_dettes() {
		return MaDette::find_dettes_on($this->id);
	}
