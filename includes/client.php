...
class Client extends DatabaseObject {
	...
	protected static $db_fields=array('id', 'nom', 'adresse', 'tel', 'Raison_sociale', 'email', 'website', 'dette');
	public $id;
	public $nom;
	public $adresse;
	public $tel;
	...
	public function ventes() {
		return Vente::find_ventes_on($this->id);
	}
	public function history_dettes() {
		return Dette::find_dettes_on($this->id);
	}
